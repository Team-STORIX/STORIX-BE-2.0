package com.storix.infrastructure.global;

import com.storix.domain.domains.user.dto.OnboardingTokenInfo;
import com.storix.domain.domains.user.exception.token.ExpiredOnboardingTokenException;
import com.storix.domain.domains.user.exception.token.ExpiredRefreshTokenException;
...
import static com.storix.common.utils.STORIXStatic.*;
