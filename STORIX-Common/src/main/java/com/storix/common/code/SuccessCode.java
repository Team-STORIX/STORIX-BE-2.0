...
public enum SuccessCode {
    ...
    APP_EVENT_BANNER_MODAL_STATUS_SUCCESS(HttpStatus.OK, "APP_EVENT_SUCCESS_006", "배너 모달 노출 여부 조회에 성공했습니다."),
    APP_EVENT_BANNER_MODAL_CONFIRM_SUCCESS(HttpStatus.OK, "APP_EVENT_SUCCESS_007", "배너 모달 확인 처리에 성공했습니다."),
